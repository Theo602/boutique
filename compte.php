...
$pageTitle = 'Espace Membre - Compte';
...
if (isset($_GET['action']) || !empty($_GET['action'])) {
    ...
    if ($_GET['action'] == "deleteNewsletter") {
        ...
        try {
            ...
            header('Location: compte.php?send=success');
            exit();
        } catch (PDOException $exception) {
            header('Location: compte.php?send=error');
            exit();
        }
    }
}
...
//$requestDetailCommande = $bdd->query("SELECT *, DATE_FORMAT(c.created_at, '%d/%m/%Y') AS created_at FROM commande c INNER JOIN user u ON 
            ...
            <div class="profil-information">
                ...
                <div class="information">
                    ...
                    <div class="fiche-information">
                        ...
                        <a href="profil.php#messageProfil">Editer</a>
                    ...
                    <div class="fiche-information">
                        ...
                        <a href="profil.php#messageAdresse">Editer</a>
                    </div>
                ...
                <p>Inscrit à la newsletter :
                    ...
                    <?php if ($newsletter) : ?>
                        Oui -
                        <a class="btnDesabonner" href="compte.php?action=deleteNewsletter">se désabonner</a>
                    <?php else : ?>
                        Non
                    <?php endif ?>
