...
$pageTitle = 'Espace Membre -Profil';
...
if (isset($_POST['btn_modifier_profil'])) {
    ...
    if (empty($error)) {
        ...
        try {
            ...
            header('Location: ' . URL . 'profil.php#messageProfil');
            exit();
        } catch (PDOException $exception) {
...
if (isset($_POST['btn_modifier_adresse'])) {
    ...
    if (empty($error)) {
        ...
        try {
            ...
            header('Location: ' . URL . 'profil.php#messageAdresse');
            exit();
        } catch (PDOException $exception) {
            $errorMotif = 'Erreur lors de la modification';
        }
...
if (isset($_POST['btn_modifier_password'])) {
    ...
    if (empty($error)) {
        ...
        try {
            ...
            header('Location: ' . URL . 'profil.php#messagePassword');
