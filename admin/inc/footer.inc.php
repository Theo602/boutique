...
<?php if (isset($bodyId)) : ?>
    ...
    <?php if ($bodyId === ADMIN_BOUTIQUE || $bodyId === ADMIN_COMPTE_MEMBRE || $bodyId === ADMIN_LISTE_COMMANDE || $bodyId === ADMIN_GESTION_NEWSLETTER || $bodyId === ADMIN_COMPTE || $bodyId === ADMIN_COMMANDE || $bodyId === ADMIN_COMMANDE_MEMBER) : ?>
